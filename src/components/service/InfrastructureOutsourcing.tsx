            ...
            <div className='body '>
                ...
                <div className="content-box flex fade-in-section">
                    <div className="content p-10">
                        <h1 className='text-gray-600 pb-3 text-2xl'><b>Infrastructure Outsourcing</b></h1>
                    ...
                    <div className="img p-10">
                        <img src="public/Outsorcing/out-img5.jpg" alt="Marketing" />
                    </div>
                </div>
                <div className='reverse-content'>
                    <div className="content-box flex fade-in-section" >
                        <div className="img p-10">
                            <img src="public/Outsorcing/out-img4.jpg" alt="Marketing" />
                        </div>
                        <div className="content p-10">
                            <h1 className='text-gray-600 pb-3 text-2xl'><b>Key Aspects of Infrastructure Outsourcing:
                            ...
                            <p className='text-l text-justify font-weight: 500  whitespace-normal'>
                                <b>  Adjustable Resources: </b>Businesses can easily scale resources up or down based on demand, avoiding over-investment or underutilization.
                                Cost Efficiency:
                            </p>
                            <br />
                ...
                <div className="content-box flex fade-in-section">
                    <div className="content p-10">
                        <h1 className='text-gray-600 pb-3 text-2xl'><b>Access to Advanced Technology
                        </b></h1>
                        <p className='text-l text-justify font-weight: 500  whitespace-normal'>
                        ...
                        <br />
                        <h1 className='text-gray-600 pb-3 text-2xl'><b>Enhanced Focus on Core Activities</b></h1>
                        <p className='text-l text-justify font-weight: 500  whitespace-normal'>
                            <b>Core Competencies:</b>  By outsourcing infrastructure management, businesses can concentrate on their primary activities and strategic goals without being bogged down by technological issues.
                        </p>

                    </div>
                    <div className="img p-10">
                        <img src="public/outsorcing/out-img6.jpg" alt="Marketing" />
                    </div>
                </div>
                <div className='reverse-content'>
                    <div className="content-box flex fade-in-section" >
                        <div className="img p-10">
                            <img src="public/Outsorcing/out-img7.jpg" alt="Marketing" />
                        </div>
                        <div className="content p-10">
                            <h1 className='text-gray-600 pb-3 text-2xl'><b>Services Typically Included:
                            </b></h1>
                            <p className='text-l text-justify whitespace-normal'>
