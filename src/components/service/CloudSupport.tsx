...
import { faCloud, faDonate } from '@fortawesome/free-solid-svg-icons';
    ...
    <div>
      ...
      <div className="container py-5">
        ...
        <div className="section-title text-center position-relative pb-3 mb-5 mx-auto" style={{ maxWidth: '600px' }} >
                <h5 className="fw-bold text-primary text-uppercase">Cloud Support</h5>
            ...
            <div className="service-item bg-light rounded">
              ...
              <div className="service-content text-center p-4">
                <div className="service-content-inner">
                  ...
                  <p className="mb-4">
                  Expert cloud application setup and management to boost your business productivity.
                  </p>
            ...
            <div className="service-item bg-light rounded">
              ...
              <div className="service-content text-center p-4">
                <div className="service-content-inner">
                  ...
                  <p className="mb-4">
                  Comprehensive cloud database services for businesses of all sizes.
                  </p>
                  <a className="btn btn-light rounded-pill py-2 px-4" href="/SoftwareTraining">Read More</a>
                </div>
              </div>
            ...
            <div className="service-item bg-light rounded">
              ...
              <div className="service-content text-center p-4">
                <div className="service-content-inner">
                  ...
                  <p className="mb-4">
                  Seamless cloud OS installation and troubleshooting across platforms.
                  </p>
            ...
            <div className="service-item bg-light rounded">
              ...
              <div className="service-content text-center p-4">
                <div className="service-content-inner">
                  ...
                  <p className="mb-4">
                  Secure and flexible cloud network solutions tailored to your needs
                  </p>
                  <a className="btn btn-light rounded-pill py-2 px-4" href="#">Read More</a>
                </div>
              </div>
