...
import { faCode, faDonate , faChevronUp, faChevronDown } from '@fortawesome/free-solid-svg-icons';
import './HomeService.css';
import SvelteSignals from './SvelteSignals'; // Import the SvelteSignals component
            ...
            <div className="service-item bg-light rounded">
              ...
              <div className="service-content text-center p-10">
                <div className="service-content-inner">
                  ...
                  <a className="btn btn-light rounded-pill py-2 px-4" href="/SoftwareDeveloper">Read More</a>
                </div>
              </div>
            </div>
          </div>
